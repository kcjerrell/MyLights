...
/// <summary>
/// https://stackoverflow.com/a/46006415/839853
/// </summary>
public static class ProcessCommandLine
{
	...
	public static List<Process> SearchProcCommandLine(string processName, string searchText)
    {
		var processes = Process.GetProcessesByName(processName);
		List<Process> matches = new();
        foreach (var p in processes)
        {
			Retrieve(p, out string cmdLine);
			if (cmdLine.Contains(searchText))
            {
				matches.Add(p);
            }
        }
