//https://www.codeproject.com/articles/30090/text-on-a-path-in-wpf
...
namespace MyLights.Util
{
    public static class GeometryHelper
    {
        public static List<Point> GetIntersectionPoints(PathGeometry FlattenedPath, double[] SegmentLengths)
        {
            ...
            return GetIntersectionPoints(pointsOnFlattenedPath, SegmentLengths);
        }

        public static List<Point> GetIntersectionPoints(List<Point> pointsOnFlattenedPath, double[] SegmentLengths)
        {
