...
namespace MyLights.Bridges.Udp2
{
    public class Bridge : ILightBridge
    {
        ...
        private static void UdpClient_MessageReceived(object sender, MessageReceivedEventArgs e)
        {
            ...
            {
                var provider = new Provider(index, udpClient);
        ...
        {
            await udpClient.SendMessage("get", "bulbs");
        }
        ...
        async public void Reload()
        {
            ...
            lightVms.Clear();
            providers.Clear();
            await udpClient.SendMessage("reload");
        }
    }
}
